...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="index.html"><img src="<?php echo NM_DIR_URI;?>/assets/images/logo2.png" alt=" " />
							...
							<ul class="dropdown-menu multi">
								<div class="row">
									...
									<div class="col-sm-4 w3l">
										<a href="women.html"><img src="<?php echo NM_DIR_URI;?>/assets/images/menu1.jpg" class="img-responsive"
												alt=""></a>
									</div>
									<div class="clearfix"></div>
								</div>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu multi multi1">
								<div class="row">
									...
									<div class="col-sm-4 w3l">
										<a href="jewellery.html"><img src="<?php echo NM_DIR_URI;?>/assets/images/menu2.jpg" class="img-responsive"
												alt=""></a>
									</div>
									<div class="clearfix"></div>
								</div>
